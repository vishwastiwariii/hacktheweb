    ...
    <form onSubmit={onSubmit} className="mt-10 space-y-4">
      <div>
        ...
        <input
          ...
          maxLength={6}
          placeholder="A1B2C3"
          className="mt-2 h-14 w-full border border-zinc-700 bg-zinc-900/40 px-4 text-2xl uppercase tracking-[0.35em] text-zinc-100 outline-none transition-colors placeholder:text-zinc-600 placeholder:tracking-[0.35em] focus:border-accent"
          {...register("joinCode")}
        />
        <p className="mt-2 text-sm text-zinc-500">
          6 characters · typed input is forced to uppercase
        </p>
        {errors.joinCode && (
